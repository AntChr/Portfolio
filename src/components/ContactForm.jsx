    ...
    <Box className="contact" sx={{ flexDirection:"column", width:"100%", height:"auto"}}>
      <Box sx={{width:"auto", height:"100%", padding:"92px 228px 92px 228px"}}>
        ...
        <Box sx={{
          ...
          width:"1465px", height:"513px",
          backgroundColor:"rgba(166, 200, 232, 0.75)",
          borderRadius:"0px 78px 0px 0px",
          padding:"52px 60px 25px 60px"
          }}>
          <Box sx={{display:"flex", flexDirection:"column", width:"824px", height:"378px",}}>
          <form ref={form} onSubmit={handleSubmit}>
            <Box sx={{display:"flex",justifyContent:"space-between", width:"840px", marginBottom:"17px"}}>
          ...
          <Box sx={{
            ...
            marginRight:"50px"
              ...
              <Box sx={{display:"flex", textAlign:"center", alignItems:"center", margin:"0px 73.750px 32px 73.750px"}}>
